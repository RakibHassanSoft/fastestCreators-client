...
const AnimatedText = () => {
  return (
    <div className="relative w-full overflow-hidden mt-8 lg:mt-32  lg:mb-32">
          ...
          ['App Development', 'Web Development', 'Logo Design', 'Video Editing', 'Graphic Design'].map(
            (text, index) => (
              <div
                ...
                className="relative text-5xl lg:text-7xl font-bold text-gray-300 hover:text-green-200 cursor-pointer transition-colors duration-300 px-16"
              >
