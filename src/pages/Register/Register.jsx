...
const RegisterPage = () => {
  ...
  const handleGoogleSignin = async (e) => {
    ...
    try {
      ...
      if (user) {
        ...
        swal(
          "Error",
          "Google sign-in failed! No user data available.",
          "error"
        );
      }
    } catch (error) {
  ...
  return (
    <div className="min-h-screen mt-0 flex items-center justify-center bg-green-900  lg:p-6">
        ...
        <div className="w-full md:w-11/12 lg:w-1/2 p-6">
            ...
            {!isAccept && (
              <div className="w-full">
                <button
                  type="submit"
                  disabled={true}
                  className="w-full bg-gray-500 text-white p-3 rounded-md text-lg font-semibold  hover:bg-teal-700 transition focus:outline-none focus:ring-2 focus:ring-teal-500"
                >
                  Create Account
                </button>
              </div>
          ...
          <div className="mt-6 flex justify-center">
            <button
              ...
              className="text-teal-600 hover:text-teal-700 transition focus:outline-none"
            >
