  ...
  return (
    <div className="bg-white text-gray-900 mt-44">
      <div className="container mx-auto px-4 py-8">
        ...
        <h2 className="text-2xl font-bold mb-2 text-green-600">Information We Collect</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mb-2 text-green-600">How We Use the Information</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mb-2 text-green-600">Links to Other Websites</h2>
        <p className="mb-4">
          Our website may contain links to other websites of interest. However, once you have used these links to leave our site, you should note that we do not have any control over that other website. Therefore, we cannot be responsible for the protection and privacy of any information which you provide whilst visiting such sites and such sites are not governed by this privacy statement. You should exercise caution and look at the privacy statement applicable to the website in question.
        </p>

        <h2 className="text-2xl font-bold mb-2 text-green-600">Controlling Your Personal Information</h2>
        <p className="mb-4">
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>You may request details of personal information which we hold about you. If you would like a copy of the information held on you, please write to [Your Company Name, Address, City, State, Zip Code] or email privacy@example.com</li>
        ...
        <h2 className="text-2xl font-bold mb-2 text-green-600">Our Commitment to Your Satisfaction</h2>
        <div className="mb-4 p-4 border-2 border-green-600 bg-green-50">
          <p className="text-lg font-bold text-green-700">
            **Money-Back Guarantee**: We are committed to ensuring that you are fully satisfied with your purchase. If, for any reason, you are not satisfied with the product or service, we offer a <span className="font-bold text-red-600">48-hour money-back guarantee</span>. Simply reach out to us within 48 hours of your purchase, and we will refund your payment in full.
          </p>
        </div>

        <h2 className="text-2xl font-bold mb-2 text-green-600">Services We Provide</h2>
        <p className="mb-4">
        ...
        <p className="mb-4">
          This privacy policy is subject to change without notice. Please check this page periodically for any updates or changes.
        </p>
      </div>
    </div>
  );
